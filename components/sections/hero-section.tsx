    ...
    <section id="home" className="min-h-screen flex flex-col items-center justify-center px-4 pt-20">
      ...
      <div className="grid grid-rows-3 gap-2 mt-10 justify-center items-center">
        ...
        <div className="flex justify-center">
          <Button className="rounded-full text-xl md:text-2xl w-full h-full flex justify-center items-center">
      ...
      {/* Divider line */}
      <div className="w-[2px] h-24 bg-gray-500 mt-16 rounded-full " />
    </section>
  )
}
